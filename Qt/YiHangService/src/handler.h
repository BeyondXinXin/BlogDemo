...
public:
	...
	static int PostStore(HttpRequest* req, HttpResponse* resp);

	static int GetRetrieve(HttpRequest* req, HttpResponse* resp);

	static int DeleteData(HttpRequest* req, HttpResponse* resp);
